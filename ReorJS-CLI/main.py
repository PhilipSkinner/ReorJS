"""
	main.py
	Simple ReorJS Command line interface

	--
	Provides a simple CLI to the ReorJS service. Allows for complete control
	of any accessible ReorJS server.
	--
