...
class StackManager(object):
	...
	def get_connection(self, dataset):
		...
		if dataset.id.value() not in self._connections:
			...
			if dataset.source_type.value() == 'local':
				...
				self._connections[dataset.id.value()] = remote.local.LocalRemote(
					name=dataset.source_name.value(),
				...
				self._connections[dataset.id.value()] = remote.mysql.MySQLRemote(
					name=dataset.source_name.value(),
					hostname=dataset.source_hostname.value(),
					port=dataset.source_port.value(),
					username=dataset.source_username.value(),
				...
				self._connections[dataset.id.value()] = remote.mongo.MongoRemote(
					name=dataset.source_name.value(),
					hostname=dataset.source_hostname.value(),
					port=dataset.source_port.value(),
					username=dataset.source_username.value(),
				...
				self._connections[dataset.id.value()] = remote.hadoop.HadoopRemote(
					name=dataset.source_name.value(),
					hostname=dataset.source_hostname.value(),
					port=dataset.source_port.value(),
					username=dataset.source_username.value(),
				...
				self._connections[dataset.id.value()] = remote.redis.RedisRemote(
					name=dataset.source_name.value(),
					hostname=dataset.source_hostname.value(),
					port=dataset.source_port.value(),
					username=dataset.source_username.value(),
				...
				self._connections[dataset.id.value()] = remote.memcached.MemcachedRemote(
					name=dataset.source_name.value(),
					hostname=dataset.source_hostname.value(),
					port=dataset.source_port.value(),
					username=dataset.source_username.value(),
	...
	def receive_result(self, cursor=None, result=None):
		...
		if connection != None:
			...
			for k, v in self._taskResultCursors[task.id.value()]['block_map'].items()	:
